...
const actions = {
    async fetchBookings({ commit }){
        ...
        if(token == null || token ==''){ 
            ...
            const response = await axios.get(`${config.BACKEND_SERVER_IP}/bookings/byprovider`,header)
    ...
    async fetchRequests({ commit }){
        ...
        if(token == null || token ==''){ 
            ...
            const response = await axios.get(`${config.BACKEND_SERVER_IP}/bookings/requests`,header)
